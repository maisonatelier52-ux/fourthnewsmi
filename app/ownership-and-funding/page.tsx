        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-10">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 font-sans">
            ...
            <div className="p-6 bg-neutral-50 border border-neutral-100 space-y-2">
              ...
              <h3 className="text-base font-bold text-black font-serif">Wall Firewall</h3>
              <p className="text-xs text-neutral-600 leading-relaxed">
          ...
          <article className="space-y-6 text-neutral-800 text-sm sm:text-base leading-relaxed font-serif">
            <h2 className="text-2xl font-serif font-bold text-black">Ownership Structure</h2>
            <p>
            ...
            <h2 className="text-2xl font-serif font-bold text-black pt-4">Revenue Breakdown</h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2 text-neutral-700">
              <li><strong className="text-black">Reader Subscriptions & Premium Membership:</strong> 55% of operating budget.</li>
              <li><strong className="text-black">Direct Programmatic & Display Advertising:</strong> 30% of operating budget.</li>
              <li><strong className="text-black">Syndication & Corporate API Licensing:</strong> 15% of operating budget.</li>
            </ul>
          </article>
        </div>
      </main>
