      ...
      <main className="w-full flex-1 py-12 font-serif">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-8">
          <div className="space-y-4 text-neutral-800 text-sm sm:text-base leading-relaxed">
            <h2 className="text-2xl font-serif font-bold text-black">Corporate Entity Information</h2>
            <p>
            ...
            <h2 className="text-2xl font-serif font-bold text-black pt-4">Regulatory & Editorial Compliance</h2>
            <p>
            ...
            <h2 className="text-2xl font-serif font-bold text-black pt-4">Copyright Agent & DMCA Notices</h2>
            <p>
            ...
            <div className="bg-[#000000] text-white p-6 space-y-2 font-sans text-xs border-l-4 border-[#c59b27]">
              <p className="font-bold text-white uppercase tracking-wider">Designated DMCA Agent</p>
              <p className="text-neutral-300">Domain Name Legal Department</p>
              <p className="text-neutral-300">750 Third Avenue, 18th Floor, New York, NY 10017</p>
              <p className="text-[#c59b27] font-bold">Email: legal@domainname.com</p>
            </div>
          </div>
        </div>
      </main>
