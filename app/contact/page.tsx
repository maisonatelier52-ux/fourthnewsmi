          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 space-y-6 font-sans">
              <div className="border-b border-slate-200 pb-3">
                <h2 className="text-2xl font-serif font-bold text-slate-950">Send a Direct Message</h2>
                <p className="text-xs text-slate-500 mt-1">Our editorial desk responds within 24 business hours.</p>
              </div>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 text-xs border border-slate-300 rounded-none bg-slate-50 focus:bg-white focus:border-blue-600 focus:outline-none"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-slate-700 block">Department *</label>
                      <select
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-slate-700 block">Subject *</label>
                      <input
                        type="text"
                        required
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-bold uppercase tracking-wider text-slate-700 block">Message *</label>
                    <textarea
                      required
                      rows={5}
                  ...
                  <button
                    type="submit"
                    className="bg-[#2563eb] hover:bg-blue-700 text-white font-sans font-bold text-xs uppercase tracking-wider px-6 py-3 transition-colors flex items-center gap-2"
                  >
            ...
            <div className="lg:col-span-5 space-y-6 font-sans">
              <div className="bg-slate-950 text-white p-6 sm:p-8 space-y-6">
                <h3 className="text-xl font-serif font-bold text-white border-b border-slate-800 pb-3">
                ...
                <div className="space-y-4 text-xs">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-300 pl-6">press@domainname.com</p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-300 pl-6">+1 (212) 555-0199</p>
                  </div>
                </div>
              </div>

              <div className="bg-slate-50 p-6 border border-slate-200 space-y-2 text-xs">
                <h4 className="font-bold text-slate-900 uppercase tracking-wider">Confidential Leaks & Tips</h4>
