      ...
      <main className="w-full flex-1 py-12 font-serif">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-8">
          <div className="space-y-4 text-slate-800 text-sm sm:text-base leading-relaxed">
            <h2 className="text-2xl font-serif font-bold text-slate-950">Pre-Publication Response Windows</h2>
            <p>
            ...
            <h2 className="text-2xl font-serif font-bold text-slate-950 pt-4">Post-Publication Right of Reply Criteria</h2>
            <p>
            ...
            <div className="bg-slate-50 p-6 border border-slate-200 space-y-3 font-sans text-xs">
              <h4 className="font-bold text-slate-950 uppercase tracking-wider">Submitting a Right of Reply Request</h4>
              <p className="text-slate-600">
                Submit your formal statement within 14 calendar days of publication to <span className="font-bold text-slate-900">standards@domainname.com</span> including:
              </p>
