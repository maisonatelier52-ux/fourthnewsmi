      ...
      <main className="w-full flex-1 py-12 font-serif">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-8">
          <div className="space-y-4 text-slate-800 text-sm sm:text-base leading-relaxed">
            ...
            <h2 className="text-2xl font-serif font-bold text-slate-950 pt-4">2. Intellectual Property Rights</h2>
            <p>
            ...
            <h2 className="text-2xl font-serif font-bold text-slate-950 pt-4">3. Permitted Personal Use</h2>
            <p>
            ...
            <h2 className="text-2xl font-serif font-bold text-slate-950 pt-4">4. User Dispatches & Comments</h2>
            <p>
            ...
            <h2 className="text-2xl font-serif font-bold text-slate-950 pt-4">5. Disclaimer of Warranties</h2>
            <p>
            ...
            <div className="bg-slate-50 p-6 border border-slate-200 mt-8 font-sans text-xs space-y-2">
              <h4 className="font-bold text-slate-900 uppercase tracking-wider">Syndication & Licensing Inquiries</h4>
              <p className="text-slate-600">
                For corporate republication rights or commercial news feed licensing, contact <span className="font-bold text-slate-900">licensing@domainname.com</span>.
              </p>
            </div>
          </div>
        </div>
